...
text = text.replace('', ' ')
print('CUI: '+ text)
imageout2= image [240:320,440:650]
text2 = str(((pytesseract.image_to_string(imageout2,lang='spa'))))
text2 = text2.replace('\n', ' ')
text2 = text2.replace('', ' ')
print('Nombre: '+text2)
imageout3= image [350:440,440:650]
...
imageout5= image [570:620,440:650]
text5 = str(((pytesseract.image_to_string(imageout5,lang='spa'))))
text5 = text5.replace('\n', ' ')
text5 = text5.replace('', ' ')
print('Sexo: '+text5)
imageout6= image [650:700,555:660]
...
if os.path.isfile('BBDDCovid')==True:
    Cursor.execute("INSERT INTO CIUDADANOS VALUES ('"+text+"', '"+text2+"', '"+text3+"', '"+text4+"', '"+text5+"', '"+text6+"','"+vacuna+"','"+dosis+"')")
if os.path.isfile('BBDDCovid')==False:
    Cursor.execute("CREATE TABLE CIUDADANOS (CUI VARCHAR(50), Nombre VARCHAR(50), Apellido VARCHAR(50), Nacionalidad VARCHAR(50), Sexo VARCHAR(50), Edad VARCHAR(50), Vacuna VARCHAR(50), Dosis VARCHAR(50))")
    Cursor.execute("INSERT INTO CIUDADANOS VALUES ('"+text+"', '"+text2+"', '"+text3+"', '"+text4+"', '"+text5+"', '"+text6+"','"+vacuna+"','"+dosis+"')")
Conexion.commit()
Conexion.close()
