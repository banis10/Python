...
client.println("<input type='checkbox' class='btn-check' id='btn-check-outlined' autocomplete='off'>");
client.println("<label class='btn btn-outline-primary' for='btn-check-outlined'>Single toggle</label><br>");
    //FIN DE LA PAGINA
